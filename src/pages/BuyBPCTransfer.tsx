  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex flex-col items-center p-6 mb-6">
        <h1 className="text-4xl font-bold mb-2">NGN 7,800</h1>
      ...
      <div className="bg-white m-5 p-5 rounded-lg border border-gray-200">
        <div className="mb-4">
          ...
          <div className="flex justify-between items-center">
            <p className="text-2xl font-bold">NGN 7,800</p>
            <Button 
              variant="default" 
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-2"
              onClick={() => handleCopy("7800", "Amount")}
            >
              <Copy size={18} />
              Copy
            </Button>
        ...
        <div className="mb-4 border-t pt-4">
          ...
          <div className="flex justify-between items-center">
            <p className="text-2xl font-bold">5120893537</p>
            <Button 
              variant="default" 
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-2"
              onClick={() => handleCopy("5120893537", "Account Number")}
            >
              <Copy size={18} />
              Copy
            </Button>
        ...
        <div className="mb-4 border-t pt-4">
          ...
          <p className="text-2xl font-bold">MONIEPOINT PSB</p>
        </div>

        <div className="mb-4 border-t pt-4">
          <p className="text-gray-500 text-sm">Account Name</p>
          <p className="text-2xl font-bold">BRIGHT EKPEREBUIKEM ISREAL</p>
        </div>
      </div>
